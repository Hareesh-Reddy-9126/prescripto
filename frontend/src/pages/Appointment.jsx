...
const Appointment = () => {
    ...
    const fetchDocInfo = useCallback(() => {
        const doctorDetails = doctors.find((doc) => doc._id === docId)
        setDocInfo(doctorDetails || false)
    }, [docId, doctors])
    ...
    const bookAppointment = async () => {
        ...
        if (!docSlots.length || !docSlots[slotIndex]?.length) {
            toast.warning('No available slots for the selected date')
            return
        }
